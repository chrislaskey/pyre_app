...
build() {
  ...
  docker build \
    ...
    --secret id=PYRE_ALLOWED_PATHS,env=PYRE_ALLOWED_PATHS \
    ...
    --secret id=PYRE_SERVER_URL,env=PYRE_SERVER_URL \
...
run() {
  ...
  docker run --rm \
    ...
    -e PYRE_ALLOWED_PATHS="${PYRE_ALLOWED_PATHS}" \
    ...
    -e PYRE_SERVER_URL="${PYRE_SERVER_URL}" \
